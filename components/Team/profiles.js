...
const teamMembers = [
  ...
  },
  {
    ...
    desc4:
      "Erica and her husband Michael moved to Idaho in 2018. They are raising four children--two boys and two girls--a few chickens, rabbits, and their dogs, Dexter andWinston. Her husband is completing his Bachelor of Science in Nursing, and in their spare time they love to travel, kayak, attend swim meets, and explore hidden treasures in Idaho and the surrounding areas.",
  },
  {
    name: "Libby Cameron ",
...
export const Profiles = () => {
  ...
  const handleReadMore = (title, desc3, desc4) => {
    setModalTitle(title);
    setModalDesc3(desc3);
    setModalDesc4(desc4);
    setShowModal(true);
        ...
        >
          ...
          <div>
            ...
            <button
              ...
              onClick={() =>
                handleReadMore(member.name, member.desc3, member.desc4)
              }
            >
